package ch.paru.scrumTools.backendServer.services;
...
import ch.paru.scrumTools.backendServer.manager.ServerFacade;
import ch.paru.scrumTools.backendServer.manager.ServerManager;
import ch.paru.scrumTools.backendServer.services.calendar.CalendarService;
import ch.paru.scrumTools.backendServer.services.calendar.impl.CalendarServiceImpl;
import ch.paru.scrumTools.backendServer.services.calendar.mock.CalendarServiceMock;
...
import ch.paru.scrumTools.backendServer.services.configuration.impl.ConfigurationServiceImpl;
import ch.paru.scrumTools.backendServer.services.contact.ContactService;
import ch.paru.scrumTools.backendServer.services.contact.impl.ContactServiceImpl;
import ch.paru.scrumTools.backendServer.services.contact.mock.ContactServiceMock;
...
import ch.paru.scrumTools.backendServer.utils.interceptors.factories.CacheInterceptorFactory;
import ch.paru.scrumTools.backendServer.utils.interceptors.factories.LogInterceptorFactory;
